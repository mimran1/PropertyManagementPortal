function expenseInsight_2020(dataIN) {
    var dataINJSON = []
    dataINJSON = JSON.parse(dataIN)
    console.log("In expenseInsight_2020:\n")
    ...
    var chart2020 = document.getElementById("expenseInsightChart_2020")
    console.log(chart2020)

    var chart = new CanvasJS.Chart("expenseInsightChart_2020", {
        theme: "light2",
